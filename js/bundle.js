...
(function() {
    ...
    const Puzzles = (function() {
        const puzzles = [
            ...
            // Topic 3.3
            { topic: '3.3', type: 'multiple_choice', stem: 'The Declaration of Independence (1776) was primarily written by:', choices: ['Benjamin Franklin', 'John Adams', 'Thomas Jefferson', 'George Washington'], correct: 2, explanation: 'Thomas Jefferson drafted the Declaration, drawing on Enlightenment philosophy and natural rights theory.' },
            { topic: '3.3', type: 'multiple_choice', stem: 'The Battle of Saratoga (1777) was a turning point because it:', choices: ['Ended the war', 'Convinced France to ally with the Americans', 'Led to British control of New England', 'Ended slavery in the North'], correct: 1, explanation: 'France entered the war as an American ally after Saratoga, providing crucial military and financial support.' },
            ...
            { topic: '4.3', type: 'multiple_choice', stem: 'The Trail of Tears (1838-39) resulted from the:', choices: ['Homestead Act', 'Indian Removal Act of 1830', 'Kansas-Nebraska Act', 'Dawes Act'], correct: 1, explanation: 'Jackson\'s Indian Removal Act forced the Cherokee and other tribes off their lands on a brutal march to Oklahoma.' },
            ...
            { topic: '6.1', type: 'multiple_choice', stem: 'The Transcontinental Railroad, completed in 1869, was built primarily by:', choices: ['American-born workers only', 'Chinese and Irish immigrant laborers', 'Enslaved people', 'The U.S. Army'], correct: 1, explanation: 'Chinese immigrants built the western section and Irish immigrants the eastern; both labored in dangerous conditions for low pay.' },
            ...
            // Topic 7.3
            { topic: '7.3', type: 'multiple_choice', stem: 'The Harlem Renaissance was a:', choices: ['Political movement demanding Black suffrage', 'Flowering of African American art, music, and literature in New York', 'Religious revival in Northern cities', 'Athletic competition among Black colleges'], correct: 1, explanation: 'The Harlem Renaissance (1920s-30s) produced landmark works by Langston Hughes, Zora Neale Hurston, and others.' },
            ...
            // Topic 7.6
            { topic: '7.6', type: 'multiple_choice', stem: 'Japanese American internment during WWII resulted in:', choices: ['Improved Japanese American rights', '120,000 Japanese Americans being forced into internment camps without due process', 'Deportation of Japanese Americans', 'No significant civil liberties violations'], correct: 1, explanation: 'Executive Order 9066 forced Japanese Americans into camps based purely on race — one of the worst civil liberties violations in American history.' },
            { topic: '7.6', type: 'multiple_choice', stem: 'D-Day (June 6, 1944) was the Allied:', choices: ['Invasion of North Africa', 'Invasion of Normandy, France — beginning the liberation of Western Europe', 'Battle of the Bulge', 'Invasion of Italy'], correct: 1, explanation: 'The Normandy invasion was the largest amphibious assault in history and opened a Western front that hastened German defeat.' },
            { topic: '7.6', type: 'multiple_choice', stem: 'The atomic bombs dropped on Japan in 1945 caused:', choices: ['Germany\'s surrender', 'Japan\'s surrender, ending WWII', 'A Japanese counter-attack', 'Soviet entry into the Pacific war only'], correct: 1, explanation: 'The bombs on Hiroshima and Nagasaki (August 6 and 9, 1945) led directly to Japan\'s surrender on August 15, 1945.' },
            ...
            // Topic 9.2
            { topic: '9.2', type: 'multiple_choice', stem: 'The Berlin Wall fell on:', choices: ['November 9, 1989', 'December 25, 1991', 'January 1, 1990', 'June 5, 1989'], correct: 0, explanation: 'The Berlin Wall fell on November 9, 1989, as East Germany opened its borders — symbolizing the end of the Cold War.' },
            ...
            { topic: '7.2', type: 'multiple_choice', stem: 'The Espionage and Sedition Acts (1917–18) made it illegal to:', choices: ['Spy for enemy nations', 'Criticize the war effort, the draft, or the government — imprisoning dissenters like Eugene Debs', 'Trade with enemy nations', 'Hire enemy aliens in defense industries'], correct: 1, explanation: 'Socialist leader Eugene Debs was sentenced to 10 years in prison for a speech opposing the draft — the Supreme Court upheld the conviction.' },
