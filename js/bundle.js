...
(function() {
    ...
    const Puzzles = (function() {
        const puzzles = [
            ...
            { topic: '1.1', type: 'multiple_choice', stem: 'Most Native American kinship systems were:', choices: ['Strictly patrilineal (descent through the father)', 'Based primarily on wealth and land ownership', 'Often matrilineal (descent through the mother)', 'Purely individual with no clan structure'], correct: 2, explanation: 'Many Native societies traced descent through the mother\'s line, giving women significant social status.' },
            ...
            { topic: '1.2', type: 'multiple_choice', stem: 'Portugal led early European exploration because of:', choices: ['Its large standing army and military dominance in Europe', 'Prince Henry the Navigator\'s sponsorship and new ship technology', 'Its close geographic location to the Americas', 'Exclusive papal support and religious authorization'], correct: 1, explanation: 'Portugal developed the caravel, navigation instruments, and Prince Henry sponsored African coastal exploration.' },
            { topic: '1.2', type: 'multiple_choice', stem: 'Vasco da Gama\'s 1498 voyage was significant because he:', choices: ['Discovered the American continent for Portugal', 'Found a sea route to India around Africa', 'Circumnavigated the entire globe for the first time', 'Mapped the Caribbean islands for European trade'], correct: 1, explanation: 'Da Gama reached India by sailing around Africa, opening direct European sea trade with Asia.' },
            ...
            // Topic 1.3
            { topic: '1.3', type: 'multiple_choice', stem: 'Hernan Cortes conquered the Aztec Empire aided by:', choices: ['Superior numbers of Spanish soldiers alone', 'Disease, Native allies, and superior weapons', 'British military support and naval superiority', 'Aztec voluntary surrender without any fighting'], correct: 1, explanation: 'Cortes combined smallpox (which devastated the Aztecs), alliances with Aztec enemies, steel armor, horses, and firearms.' },
            { topic: '1.3', type: 'multiple_choice', stem: 'The most important factor in European conquest of Native Americans was:', choices: ['Better military tactics and battlefield strategies', 'Superior weapons such as steel swords and firearms', 'European diseases to which Natives had no immunity', 'Larger armies with more trained soldiers'], correct: 2, explanation: 'Diseases like smallpox killed 50-90% of indigenous populations, making military conquest far easier.' },
            ...
            // Topic 1.4
            { topic: '1.4', type: 'multiple_choice', stem: 'The encomienda system was:', choices: ['A fair wage system for Native workers in colonial mines', 'A system of forced Native labor granted to Spanish colonists', 'A land grant program giving territory to Native peoples', 'A religious conversion program run by Spanish missionaries'], correct: 1, explanation: 'The encomienda granted Spanish colonists authority over Native workers, who were forced to labor — essentially enslavement.' },
            { topic: '1.4', type: 'multiple_choice', stem: 'Bartolome de las Casas is remembered for:', choices: ['Leading the conquest of the Aztec Empire in Mexico', 'Documenting and condemning Spanish cruelty against Native peoples', 'Establishing the colony of New Spain and governing it', 'Charting and mapping the Gulf of Mexico coastline'], correct: 1, explanation: 'Las Casas, a Dominican friar, witnessed and recorded Spanish atrocities and advocated for Native rights.' },
            ...
            { topic: '1.4', type: 'multiple_choice', stem: 'Spanish missionaries established missions in order to:', choices: ['Build military bases to defend Spanish colonial territory', 'Convert Native peoples to Christianity and use their labor', 'Create democratic local governments for Native communities', 'Establish profitable trade networks for gold and silver'], correct: 1, explanation: 'Franciscan and Jesuit missions served both religious conversion and as economic enterprises using Native labor.' },
            ...
            // Topic 1.6
            { topic: '1.6', type: 'multiple_choice', stem: 'The Columbian Exchange refers to:', choices: ['The trading system established between Spanish colonies in the Americas', 'The transfer of plants, animals, and diseases between the Eastern and Western Hemispheres', 'The specific trade routes Columbus followed on his four voyages', 'The formal exchange of gold from America for silver from Europe'], correct: 1, explanation: 'The Columbian Exchange permanently connected the ecosystems of the Old and New Worlds after 1492.' },
            ...
            { topic: '2.2', type: 'multiple_choice', stem: 'John Winthrop described Massachusetts Bay Colony as:', choices: ['A land of boundless economic opportunity and personal freedom', '"A City upon a Hill" — a model Christian community', 'A military outpost defending England against French and Dutch rivals', 'A profitable trading post focused on commerce with Native peoples'], correct: 1, explanation: 'Winthrop\'s sermon called on colonists to create a perfect Puritan community that would be an example to the world.' },
            { topic: '2.2', type: 'multiple_choice', stem: 'Roger Williams was banished from Massachusetts Bay because he:', choices: ['Refused to pay colonial taxes to the Massachusetts government', 'Challenged Puritan authority and advocated separation of church and state', 'Supported the English king over the elected colonial assembly', 'Led an armed rebellion against the Puritan colonial leadership'], correct: 1, explanation: 'Williams believed the civil government had no authority over religious matters; he founded Rhode Island after banishment.' },
            ...
            { topic: '2.5', type: 'multiple_choice', stem: 'Enslaved people in the colonial period resisted bondage through:', choices: ['Open military revolt only, since other methods were too risky', 'Slow work, sabotage, flight, and occasional uprisings', 'Legal challenges and petitioning courts for freedom only', 'They accepted their condition and did not meaningfully resist'], correct: 1, explanation: 'Resistance took many forms — both everyday acts of defiance and organized revolts.' },
            ...
            // ===== UNIT 3: Period 3, 1754-1800 =====
            // Topic 3.1
            { topic: '3.1', type: 'multiple_choice', stem: 'The French and Indian War (1754-1763) was a conflict between:', choices: ['France and its Native American allies fighting for independence', 'Britain and France, with most Native Americans siding with France', 'England and its rebellious American colonies over taxation rights', 'France and Spain competing for control of North American territory'], correct: 1, explanation: 'Most Native Americans allied with France, which had better trade relationships and fewer land-hungry settlers.' },
            ...
            // Topic 3.2
            { topic: '3.2', type: 'multiple_choice', stem: 'The slogan "No taxation without representation" expressed the colonial argument that:', choices: ['All taxes on trade and commerce are inherently unjust and wrong', 'Only Parliament had the legitimate constitutional authority to levy taxes', 'Colonists should not be taxed by a legislature in which they had no representatives', 'Every British tax imposed on the colonies was constitutionally illegal'], correct: 2, explanation: 'Colonists argued that English constitutional tradition required the consent of the taxed through their elected representatives.' },
            ...
            { topic: '3.2', type: 'multiple_choice', stem: 'Colonists used John Locke\'s ideas to argue that:', choices: ['Kings ruled by divine right and could not be challenged by subjects', 'Citizens had natural rights and could overthrow unjust government', 'Parliament had absolute power over all laws including colonial affairs', 'Religion and the church should govern political decisions and leadership'], correct: 1, explanation: 'Locke\'s social contract theory — that government must protect rights and derives power from the people — justified resistance to British rule.' },
            ...
            { topic: '3.4', type: 'multiple_choice', stem: 'Shays\' Rebellion (1786-87) demonstrated:', choices: ['The surprising strength and effectiveness of the new federal government', 'The weakness of the government under the Articles of Confederation', 'That American democracy was working perfectly and needed no changes', 'That rural farmers and their economic concerns were politically unimportant'], correct: 1, explanation: 'When the government couldn\'t suppress a farmers\' rebellion in Massachusetts, it alarmed leaders into calling the Constitutional Convention.' },
            { topic: '3.4', type: 'multiple_choice', stem: 'The Northwest Ordinance (1787) was significant because it:', choices: ['Created the District of Columbia as the permanent national capital site', 'Organized territory north of the Ohio River and banned slavery there', 'Established the first permanent American settlement west of the Appalachians', 'Created the Supreme Court and defined its jurisdiction and powers'], correct: 1, explanation: 'The Northwest Ordinance established a process for new states and banned slavery in the Northwest Territory — a major precedent.' },
            ...
            { topic: '3.6', type: 'multiple_choice', stem: 'Marbury v. Madison (1803) established the principle of:', choices: ['Presidential veto power over all acts passed by Congress', 'Judicial review — the Supreme Court\'s power to strike down unconstitutional laws', 'State sovereignty over federal law within state borders', 'Freedom of religion as protected from congressional interference'], correct: 1, explanation: 'Chief Justice Marshall\'s ruling established that the Supreme Court could declare laws unconstitutional — a cornerstone of American government.' },
            { topic: '3.6', type: 'multiple_choice', stem: 'The "Revolution of 1800" was significant because:', choices: ['It involved armed conflict between Federalists and Democratic-Republicans', 'Power peacefully transferred from Federalists to Democratic-Republicans — a first in world history', 'Jefferson abolished the Constitution and replaced it with a new document', 'It ended the two-party system and created a single dominant party'], correct: 1, explanation: 'Jefferson\'s election demonstrated that power could transfer peacefully between rival political parties — a revolutionary concept at the time.' },
            ...
            // Topic 4.2
            { topic: '4.2', type: 'multiple_choice', stem: 'The Erie Canal (1825) was significant because it:', choices: ['Connected the Atlantic and Pacific oceans through a water passage', 'Linked the Great Lakes to New York City, transforming trade', 'Was the first railroad built in the United States of America', 'Allowed ships to bypass New Orleans and reach the interior'], correct: 1, explanation: 'The Erie Canal dramatically reduced shipping costs, making New York City the commercial capital and opening western markets.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Erie_canal_1905.jpg/640px-Erie_canal_1905.jpg', caption: 'The Erie Canal, c. 1905 (public domain)' } },
            ...
            { topic: '5.1', type: 'multiple_choice', stem: 'The Dred Scott decision (1857) ruled that:', choices: ['Slavery was illegal in all federal territories and could not expand', 'Congress had no power to ban slavery anywhere and enslaved people were property, not citizens', 'Territories could ban slavery by popular vote of their settlers', 'Free Black people were full citizens entitled to all constitutional rights'], correct: 1, explanation: 'Chief Justice Taney\'s ruling declared that enslaved people had no constitutional rights and Congress could not prohibit slavery in territories.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Dred_Scott_photograph_%281857%29.jpg/360px-Dred_Scott_photograph_%281857%29.jpg', caption: 'Dred Scott, 1857 (public domain)' } },
            ...
            { topic: '5.3', type: 'multiple_choice', stem: 'The Union\'s main advantage over the Confederacy was:', choices: ['Better military leadership with more experienced and talented generals', 'A stronger defensive position on familiar home territory and terrain', 'Larger population and industrial capacity', 'Strong support and military aid from European allied nations'], correct: 2, explanation: 'The Union had 22 million people vs. 9 million (including 3.5 million enslaved), plus factories, railroads, and a navy.' },
            { topic: '5.3', type: 'multiple_choice', stem: 'Sherman\'s March to the Sea (1864) was a strategy of:', choices: ['One quick massive frontal assault directly on Confederate forces', 'Total war — destroying the South\'s economic capacity and will to fight', 'Blockading Southern ports to cut off trade and supplies', 'Negotiating a peace settlement directly with Confederate leaders'], correct: 1, explanation: 'Sherman deliberately destroyed Confederate supply lines, farms, and railroads to break the South\'s ability and will to continue the war.' },
            ...
            // ===== UNIT 6: Period 6, 1865-1898 =====
            // Topic 6.1
            { topic: '6.1', type: 'multiple_choice', stem: 'Mark Twain called the late 19th century the "Gilded Age" because:', choices: ['Gold was discovered in the West, creating widespread prosperity for everyone', 'It glittered with wealth on the surface but had corruption and inequality beneath', 'It was a golden age of genuine democratic progress and equality', 'Gold was used as the sole currency backing the entire American economy'], correct: 1, explanation: 'Twain\'s term captured the era\'s dazzling prosperity concealing deep inequality, corruption, and exploitation.' },
            ...
            // Topic 6.2
            { topic: '6.2', type: 'multiple_choice', stem: 'Vertical integration (used by Carnegie) meant:', choices: ['Merging with direct competitors to gain a monopoly in the steel market', 'Controlling all stages of production from raw materials to finished product', 'Raising prices as high as possible to maximize profit margins', 'Paying workers far less than competitors to undercut their labor costs'], correct: 1, explanation: 'Carnegie controlled his own iron mines, steel mills, and railroads — capturing profit at every stage of production.' },
            ...
            { topic: '6.2', type: 'multiple_choice', stem: 'John D. Rockefeller\'s Standard Oil is an example of:', choices: ['Vertical integration — controlling every stage of oil production and delivery', 'Horizontal integration — dominating one industry by buying out competitors', 'A government-owned enterprise operating under federal oversight and regulation', 'A worker cooperative where employees shared ownership and profits equally'], correct: 1, explanation: 'Rockefeller used horizontal integration to control 90% of American oil refining by buying out or destroying competitors.' },

            // Topic 6.3
            { topic: '6.3', type: 'multiple_choice', stem: 'The Knights of Labor was distinctive for:', choices: ['Accepting only skilled tradesmen and rejecting unskilled factory workers', 'Being open to all workers including women and Black workers', 'Focusing only on higher wages and rejecting all other workplace demands', 'Strongly opposing any government regulation of business or industry'], correct: 1, explanation: 'Unlike most unions, the Knights accepted workers regardless of skill, race, or gender — radical for the 1880s.' },
            { topic: '6.3', type: 'multiple_choice', stem: 'The Homestead Strike (1892) was significant because:', choices: ['Workers won a major wage increase and recognition of the union', 'Carnegie Steel used Pinkerton detectives and National Guard to crush the union', 'It led directly to the passage of major new federal labor protection laws', 'It was the first national strike to involve workers across multiple industries'], correct: 1, explanation: 'The crushing of the Homestead Strike showed that corporations could use private and government force to defeat labor organizing.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/The_Carnegie_Steel_Company%27s_Homestead_Steel_Works_in_1892.jpg/640px-The_Carnegie_Steel_Company%27s_Homestead_Steel_Works_in_1892.jpg', caption: 'Carnegie Steel Company\'s Homestead Works, 1892 (public domain)' } },
            ...
            // Topic 6.4
            { topic: '6.4', type: 'multiple_choice', stem: 'Jim Crow laws enforced:', choices: ['Child labor protections and safety standards in Southern factories', 'Racial segregation in all areas of public life', 'Equal wages for Black and white workers doing the same jobs', 'Voting rights and political representation for Black men in the South'], correct: 1, explanation: 'Jim Crow laws mandated racial separation in schools, transportation, restaurants, and virtually every public space.' },
            ...
            // Topic 6.5
            { topic: '6.5', type: 'multiple_choice', stem: 'The Dawes Act (1887) was intended to:', choices: ['Give Native Americans more reservation land and expand their territorial rights', 'Assimilate Native Americans by breaking up tribal lands into individual allotments', 'Preserve and protect Native American culture and traditional ways of life', 'Create self-governing Native American states within the United States'], correct: 1, explanation: 'The Dawes Act broke up reservations into individual plots, with "surplus" land sold to whites — devastating tribal land ownership.' },
            ...
            // Topic 6.6
            { topic: '6.6', type: 'multiple_choice', stem: '"Yellow journalism" during the Spanish-American War refers to:', choices: ['Cowardly and irresponsible reporting by journalists who fled the combat zone', 'Sensationalized, exaggerated reporting designed to inflame public opinion and increase newspaper sales', 'Careful, accurate, and unbiased war coverage that told all sides of the story', 'Anti-war journalism that opposed American involvement in the Cuban conflict'], correct: 1, explanation: 'Newspapers like Hearst\'s New York Journal published sensationalized stories about Spanish atrocities to sell papers and push America toward war.' },
            ...
            // ===== UNIT 7: Period 7, 1890-1945 =====
            // Topic 7.1
            { topic: '7.1', type: 'multiple_choice', stem: 'Muckrakers were journalists who:', choices: ['Covered only foreign policy and international affairs for major newspapers', 'Exposed corruption and social problems through investigative reporting', 'Supported big business and published favorable stories about industrialists', 'Worked directly for the government as official press and communications officers'], correct: 1, explanation: 'Muckrakers like Upton Sinclair, Ida Tarbell, and Lincoln Steffens used journalism to expose abuses that spurred reform.' },
            { topic: '7.1', type: 'multiple_choice', stem: 'Theodore Roosevelt\'s approach to the presidency was to use it as a:', choices: ['Ceremonial position that deferred all important decisions to Congress', '"Bully pulpit" — a platform to promote progressive reform', 'Vehicle for isolationism and withdrawal from international affairs', 'Tool to protect big business from government regulation and oversight'], correct: 1, explanation: 'TR aggressively used presidential power to regulate trusts, protect consumers, and conserve natural resources.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/President_Roosevelt_-_Pach_Bros_%28cropped%29.jpg/440px-President_Roosevelt_-_Pach_Bros_%28cropped%29.jpg', caption: 'President Theodore Roosevelt (Library of Congress, public domain)' } },
            ...
            { topic: '7.2', type: 'multiple_choice', stem: 'Wilson\'s Fourteen Points included:', choices: ['U.S. annexation of former German colonial territories in Africa and Asia', 'A League of Nations to maintain international peace', 'Harsh financial reparations imposed on Germany to punish it for the war', 'Continuation of European colonial empires under international supervision'], correct: 1, explanation: 'The Fourteen Points proposed self-determination, freedom of the seas, disarmament, and most importantly a League of Nations.' },
            { topic: '7.2', type: 'multiple_choice', stem: 'The U.S. Senate rejected the Treaty of Versailles because:', choices: ['The peace terms imposed on Germany were judged far too harsh and vindictive', 'It would commit the U.S. to the League of Nations and potentially to foreign wars', 'Wilson stubbornly refused to negotiate any changes or accept any reservations', 'France and Britain openly opposed American ratification of the treaty'], correct: 1, explanation: 'Senator Henry Cabot Lodge and other "irreconcilables" opposed joining the League as a threat to American sovereignty.' },
            ...
            { topic: '7.3', type: 'multiple_choice', stem: 'The Immigration Act of 1924:', choices: ['Opened America equally to all immigrants regardless of national origin', 'Dramatically restricted immigration, especially from Southern/Eastern Europe and Asia', 'Only affected Asian immigrants and left European immigration quotas unchanged', 'Increased immigration quotas to bring in more workers for expanding industries'], correct: 1, explanation: 'The Act set quotas based on national origin (favoring Northwestern Europe) and virtually banned Asian immigration.' },
            ...
            { topic: '7.4', type: 'multiple_choice', stem: 'FDR\'s New Deal aimed at:', choices: ['Eliminating government regulation and returning the economy to free market principles', '"Relief, recovery, and reform" — helping people immediately, reviving the economy, and preventing future depressions', 'Military buildup to provide jobs through defense manufacturing and service', 'Reversing the Progressive Era reforms that had expanded government oversight'], correct: 1, explanation: 'Roosevelt\'s three-part framework addressed immediate suffering, economic recovery, and long-term structural reform.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/FDR_1944_Color_Portrait.jpg/440px-FDR_1944_Color_Portrait.jpg', caption: 'President Franklin D. Roosevelt, 1944 (public domain)' } },
            ...
            // Topic 7.5
            { topic: '7.5', type: 'multiple_choice', stem: 'The Munich Agreement (1938) is remembered as an example of:', choices: ['Successful diplomacy that prevented a second world war through negotiation', 'Appeasement — rewarding Hitler\'s aggression, which encouraged further aggression', 'Effective military deterrence that forced Hitler to accept limited territorial gains', 'Collective security working as nations united to stand firm against Nazi demands'], correct: 1, explanation: 'Britain and France gave Hitler Czechoslovakia\'s Sudetenland hoping to satisfy him; he invaded the rest of Czechoslovakia 6 months later.' },
            { topic: '7.5', type: 'multiple_choice', stem: 'The Lend-Lease Act (1941) allowed the U.S. to:', choices: ['Draft American soldiers and send them directly to fight in the European theater', 'Supply Britain and other allies with war materials without immediate payment', 'Formally declare war on Germany and join the Allied powers', 'Impose sweeping economic sanctions and trade embargoes on Japan'], correct: 1, explanation: 'Lend-Lease was a way to help Britain while technically maintaining neutrality — moving the U.S. closer to full involvement.' },
            ...
            // Topic 7.6
            { topic: '7.6', type: 'multiple_choice', stem: 'Japanese American internment during WWII resulted in:', choices: ['Improved Japanese American rights as a reward for wartime loyalty and service', '120,000 Japanese Americans being forced into internment camps without due process', 'Permanent deportation of Japanese Americans back to Japan after the war', 'No significant civil liberties violations, as internees were treated humanely'], correct: 1, explanation: 'Executive Order 9066 forced Japanese Americans into camps based purely on race — one of the worst civil liberties violations in American history.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Manzanar_War_Relocation_Center_barracks.jpg/640px-Manzanar_War_Relocation_Center_barracks.jpg', caption: 'Manzanar War Relocation Center, California (Ansel Adams / public domain)' } },
            ...
            // ===== UNIT 8: Period 8, 1945-1980 =====
            // Topic 8.1
            { topic: '8.1', type: 'multiple_choice', stem: 'The policy of "containment" meant:', choices: ['Actively destroying communism worldwide through military invasion of communist states', 'Stopping the spread of communism without directly attacking the Soviet Union', 'Containing and limiting the growth of Soviet nuclear weapons through arms control', 'Identifying and containing American domestic communists through surveillance and prosecution'], correct: 1, explanation: 'George Kennan proposed that the U.S. should firmly resist Soviet expansion wherever it occurred, without attacking the USSR directly.' },
            { topic: '8.1', type: 'multiple_choice', stem: 'The Marshall Plan (1947) provided:', choices: ['Military weapons and arms to rebuild Western Europe\'s devastated armed forces', 'Economic aid to rebuild Western European economies and prevent communist influence', 'American military troops to defend Western Europe from Soviet invasion', 'Shared nuclear weapons technology to help NATO allies deter Soviet aggression'], correct: 1, explanation: 'The $13 billion Marshall Plan rebuilt Western European economies, making communism less appealing to war-devastated populations.' },
            ...
            // Topic 8.2
            { topic: '8.2', type: 'multiple_choice', stem: 'McCarthyism referred to:', choices: ['Senator McCarthy\'s aggressive foreign policy of confronting the Soviet Union directly', 'Making reckless, unsubstantiated accusations of communist activity that destroyed careers', 'An economic policy favoring military spending over domestic social programs', 'The military strategy used by the U.S. Army to fight the Korean War'], correct: 1, explanation: 'McCarthy\'s accusations of communist infiltration — mostly unsupported — destroyed careers and created a climate of fear.' },
            ...
            { topic: '8.4', type: 'multiple_choice', stem: 'LBJ\'s Great Society programs included:', choices: ['NATO expansion and a massive military buildup to confront Soviet power', 'Medicare, Medicaid, education funding, and civil rights legislation', 'Privatization of Social Security to allow workers to invest in the stock market', 'Major reduction of federal spending to balance the budget and cut the deficit'], correct: 1, explanation: 'The Great Society was the most ambitious domestic program since the New Deal, fundamentally expanding the welfare state.' },
            ...
            { topic: '8.6', type: 'multiple_choice', stem: 'Nixon\'s policy of detente with China and the USSR was significant because:', choices: ['It immediately and permanently ended the Cold War and Soviet-American rivalry', 'It eased Cold War tensions and opened diplomatic/trade relations with communist powers', 'It dramatically increased military spending to pressure the Soviets into negotiations', 'It was flatly rejected by Congress as dangerous to American national security'], correct: 1, explanation: 'Nixon\'s realpolitik approached China and the USSR pragmatically, reducing Cold War tensions and opening economic relations.' },
            ...
            // ===== UNIT 9: Period 9, 1980-Present =====
            // Topic 9.1
            { topic: '9.1', type: 'multiple_choice', stem: 'Reagan\'s economic policy ("Reaganomics") was based on:', choices: ['Raising taxes on the wealthy and corporations to fund expanded social programs', 'Supply-side economics — cutting taxes (especially on wealthy) to stimulate growth', 'Nationalizing key industries so the government could manage the economy directly', 'Significantly increasing the federal minimum wage to boost consumer spending'], correct: 1, explanation: 'Supply-side theory held that tax cuts for businesses and the wealthy would "trickle down" to all Americans through investment and growth.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Official_Portrait_of_President_Reagan_1981.jpg/480px-Official_Portrait_of_President_Reagan_1981.jpg', caption: 'President Ronald Reagan, official portrait, 1981 (public domain)' } },
            { topic: '9.1', type: 'multiple_choice', stem: 'The Religious Right became politically powerful in the 1980s by opposing:', choices: ['The Cold War arms race and advocating peaceful diplomacy with the Soviet Union', 'Abortion, LGBTQ rights, and advocating traditional Christian values in public life', 'Free trade agreements that they argued harmed American workers and families', 'Reagan\'s tax cuts, which they argued benefited the wealthy at others\' expense'], correct: 1, explanation: 'Evangelical Christians organized politically around issues like abortion (Roe v. Wade) and became a crucial Republican constituency.' },
            ...
            { topic: '9.2', type: 'multiple_choice', stem: 'Mikhail Gorbachev\'s reforms — glasnost and perestroika — resulted in:', choices: ['Strengthening Soviet communism and renewing popular support for the Communist Party', 'Unleashing forces that led to the collapse of the Soviet Union', 'Successfully transforming the USSR into a Western-style multiparty democracy', 'A decisive Soviet military victory ending the costly war in Afghanistan'], correct: 1, explanation: 'Gorbachev\'s opening reforms allowed people to criticize the system; once started, the process of dissolution could not be stopped.' },
            ...
            // Topic 9.4
            { topic: '9.4', type: 'multiple_choice', stem: 'The financial crisis of 2008 was primarily caused by:', choices: ['Excessive government spending on social programs that created unsustainable deficits', 'Risky subprime mortgage lending combined with deregulated financial instruments and speculation', 'Growing trade deficits with China that drained American wealth and investment', 'Sharply rising energy prices that made transportation and manufacturing too costly'], correct: 1, explanation: 'The collapse of the housing bubble, enabled by deregulation and complex mortgage-backed securities, triggered a global financial crisis.' },
            ...
            { topic: '9.4', type: 'multiple_choice', stem: 'The dot-com boom and bust (1995-2001) reflected:', choices: ['Excessive government spending on technology subsidies that created a market distortion', 'Speculative investment in internet companies that lacked sustainable business models', 'Solid economic fundamentals that made internet companies extremely valuable long-term', 'Real estate speculation in Silicon Valley that drove up land and building costs'], correct: 1, explanation: 'Investors poured money into internet startups with no clear path to profitability; when the bubble burst, trillions in paper wealth vanished.' },

            // Topic 9.5
            { topic: '9.5', type: 'multiple_choice', stem: 'The September 11, 2001 attacks were carried out by:', choices: ['The Taliban government of Afghanistan acting on orders from its leadership', 'Al-Qaeda terrorists led by Osama bin Laden', 'Iraqi government agents acting on orders from Saddam Hussein\'s regime', 'Domestic American terrorists protesting U.S. foreign policy in the Middle East'], correct: 1, explanation: '19 al-Qaeda members hijacked four planes; Osama bin Laden claimed responsibility for the attacks.' },
            ...
            // Topic 9.6
            { topic: '9.6', type: 'multiple_choice', stem: 'The Affordable Care Act (2010) primarily aimed to:', choices: ['Create a government-run single-payer healthcare system replacing private insurance', 'Expand access to health insurance while maintaining private insurance', 'Privatize Medicare and Medicaid by turning them over to insurance companies', 'Immediately reduce total healthcare spending by cutting hospital reimbursement rates'], correct: 1, explanation: 'The ACA created health exchanges, expanded Medicaid, and required most Americans to have coverage — reducing uninsured rates significantly.' },
            ...
            { topic: '1.4', type: 'multiple_choice', stem: 'Catholic missions in Spanish North America served to:', choices: ['Protect Native autonomy and preserve their traditional cultures and practices', 'Convert Natives to Christianity and use their labor', 'Create self-governing Native communities independent from Spanish colonial control', 'Only provide formal European-style education to Native children and adults'], correct: 1, explanation: 'Missions simultaneously served religious, economic, and colonial purposes — converting Natives while putting them to work.' },
            ...
            // Unit 4 extras
            { topic: '4.1', type: 'multiple_choice', stem: 'McCulloch v. Maryland (1819) ruled that states could not tax the federal bank because:', choices: ['Banks were private property not subject to state government regulation or taxation', 'The power to tax implies the power to destroy — states cannot destroy federal institutions', 'Congress had not passed any law explicitly authorizing states to impose such taxes', 'Only Congress held the constitutional authority to create or approve any taxes'], correct: 1, explanation: 'Marshall\'s ruling established federal supremacy and the doctrine of implied powers — the bank was constitutional under the "necessary and proper" clause.' },
            ...
            { topic: '5.2', type: 'multiple_choice', stem: 'Confederate Vice President Alexander Stephens stated the Confederacy\'s "cornerstone" was:', choices: ['States\' rights and the principle of local self-governance over federal power', 'The great truth of racial inequality and the institution of slavery', 'Free trade and agricultural prosperity free from Northern tariff interference', 'Limited government and the protection of individual liberty from federal overreach'], correct: 1, explanation: 'Stephens\'s "Cornerstone Speech" (1861) explicitly stated the Confederacy was founded on the premise that racial slavery was the natural condition.' },
            ...
            { topic: '5.3', type: 'multiple_choice', stem: 'The Union\'s Anaconda Plan aimed to win by:', choices: ['One overwhelming frontal assault directly on Richmond to capture the Confederate capital', 'Blockading Southern ports, controlling the Mississippi, and strangling the Confederacy economically', 'Capturing and occupying every major Southern city to break Confederate morale', 'Immediately arming the enslaved population to fight for the Union from within'], correct: 1, explanation: 'General Winfield Scott\'s strategy treated the Confederacy like a body to be squeezed — cutting off supplies and splitting territory.' },
            ...
            { topic: '5.5', type: 'multiple_choice', stem: 'Black Codes passed by Southern states after the war were intended to:', choices: ['Protect the civil rights of freed people and ensure fair wages for their labor', 'Restrict freed people\'s movement, labor, and rights to recreate conditions similar to slavery', 'Encourage Black Southerners to voluntarily migrate to Northern states and cities', 'Demonstrate compliance with federal Reconstruction guidelines to regain congressional representation'], correct: 1, explanation: 'Black Codes required Black people to sign annual labor contracts, banned them from certain occupations, and allowed arrest for "vagrancy" — reestablishing forced labor.' },
            ...
            // Unit 6 extras
            { topic: '6.1', type: 'multiple_choice', stem: 'The Bessemer process was significant because it made:', choices: ['Cheap iron production possible by reducing the need for skilled metalworkers', 'Large-scale cheap steel production possible, enabling railroads and skyscrapers', 'Affordable electricity available to power factories and light American cities', 'Cotton processing significantly more efficient and less labor-intensive in the South'], correct: 1, explanation: 'Cheap steel transformed American industry — railroads, bridges, skyscrapers, and machines all depended on it.' },
            ...
            { topic: '6.2', type: 'multiple_choice', stem: 'A "trust" in the Gilded Age sense allowed:', choices: ['Workers to form unions and collectively bargain for better wages and conditions', 'Multiple corporations to be controlled by a single board of trustees, eliminating competition', 'Consumers to verify and trust the quality and safety of manufactured goods', 'Banks to safely hold large deposits from wealthy industrial investors'], correct: 1, explanation: 'Trusts placed competing companies under one board\'s control — in practice creating monopolies while technically maintaining separate companies.' },
            { topic: '6.2', type: 'multiple_choice', stem: 'Social Darwinism applied to Gilded Age business argued that:', choices: ['Workers deserved higher wages and a share of profits because their labor created all value', 'Economic competition was natural selection — the strongest businesses deserved to win', 'Government should actively control monopolies to protect consumers and competitors', 'Society would benefit if wealth was distributed equally among all citizens'], correct: 1, explanation: 'Applying Darwin\'s "survival of the fittest" to economics, Social Darwinists like Herbert Spencer argued that helping the poor was against nature.' },
            ...
            { topic: '6.3', type: 'multiple_choice', stem: 'The Haymarket Riot (1886) damaged the labor movement because:', choices: ['Striking workers killed many factory owners and supervisors during the confrontation', 'A bombing killed police at a labor rally, turning public opinion against unions', 'Strikers burned down several major factories, causing widespread public outrage', 'The government immediately banned all union organizing and collective bargaining after it'], correct: 1, explanation: 'Though labor leaders were almost certainly not responsible for the bomb, the Haymarket affair associated unions with radicalism and anarchism.' },
            { topic: '6.3', type: 'multiple_choice', stem: 'The Pullman Strike (1894) ended when:', choices: ['Workers won better wages and more humane housing conditions from the company', 'President Cleveland sent federal troops over the Illinois governor\'s objection, crushing the strike', 'J.P. Morgan personally brokered a compromise settlement between workers and management', 'The Supreme Court ruled in workers\' favor, ordering Pullman to meet their demands'], correct: 1, explanation: 'Cleveland used the injunction against the strike (claiming it disrupted mail delivery) and sent troops — setting a precedent for using federal power against labor.' },
            ...
            { topic: '6.4', type: 'multiple_choice', stem: 'Ida B. Wells is best remembered for:', choices: ['Founding the NAACP as its sole organizer and primary early leader', 'Documenting and campaigning against lynching as a tool of racial terror', 'Writing and publishing the very first African American newspaper in the country', 'Leading the Montgomery Bus Boycott and organizing the Black community\'s response'], correct: 1, explanation: 'Wells\'s investigations showed that lynching was not about crime but about maintaining white supremacy — her journalism was groundbreaking and dangerous.' },
            ...
            { topic: '6.5', type: 'multiple_choice', stem: 'The "closing of the frontier" was declared by historian Frederick Jackson Turner in 1893 who argued:', choices: ['All the desirable Western land had been sold and no more was available for homesteaders', 'The frontier had shaped American democracy and its end was a defining moment', 'Native Americans had been fully assimilated into mainstream American culture and society', 'Western settlement had proved to be an economic failure that bankrupted the government'], correct: 1, explanation: 'Turner\'s "Frontier Thesis" argued that the frontier experience had created American individualism and democracy — its closing raised questions about America\'s future.' },
            ...
            { topic: '7.2', type: 'multiple_choice', stem: 'The Espionage and Sedition Acts (1917–18) made it illegal to:', choices: ['Spy for or provide intelligence to enemy nations during the war', 'Criticize the war effort, the draft, or the government — imprisoning dissenters like Eugene Debs', 'Trade with or sell goods to enemy nations or their allies', 'Hire enemy aliens or foreign nationals in American defense industries'], correct: 1, explanation: 'Socialist leader Eugene Debs was sentenced to 10 years in prison for a speech opposing the draft — the Supreme Court upheld the conviction.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Uncle_Sam_%28pointing_finger%29.jpg/400px-Uncle_Sam_%28pointing_finger%29.jpg', caption: '"I Want YOU" by James Montgomery Flagg, 1917 (public domain)' } },
            ...
            { topic: '7.3', type: 'multiple_choice', stem: 'The KKK\'s revival in the 1920s differed from the Reconstruction-era KKK by:', choices: ['Being far less violent and focusing only on political campaigns and lobbying', 'Targeting not only Black people but also Catholics, Jews, immigrants, and moral transgressors', 'Operating only in the Deep South rather than spreading to other regions', 'Being a much smaller fringe organization with little mainstream political influence'], correct: 1, explanation: 'The 1920s KKK had 3–6 million members nationwide, targeting anyone seen as threatening "traditional American" (Protestant, white) values.' },

            { topic: '7.4', type: 'multiple_choice', stem: 'Hoover\'s response to the Great Depression was criticized for:', choices: ['Spending too much money on relief programs that created dependency among Americans', 'Relying on voluntarism and refusing direct government relief to suffering Americans', 'Dramatically raising income taxes too quickly while the economy was already collapsing', 'Nationalizing failing banks and industries too aggressively, scaring private investors away'], correct: 1, explanation: 'Hoover believed government handouts would destroy character; by the time he acted more forcefully, the Depression was catastrophic.', image: { url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Dust_bowl_-_dallas_south_dakota_1936.jpg/640px-Dust_bowl_-_dallas_south_dakota_1936.jpg', caption: 'Dust Bowl, Dallas, South Dakota, 1936 (public domain)' } },
            { topic: '7.4', type: 'multiple_choice', stem: 'The "Bonus Army" (1932) was significant because:', choices: ['It was a private army hired by industrialists to intimidate workers and unions', 'Veterans marching to demand early payment of promised bonuses were violently dispersed by the U.S. Army', 'Veterans successfully received their promised bonuses and returned home without incident', 'It demonstrated Hoover\'s genuine compassion and generous support for America\'s veterans'], correct: 1, explanation: 'MacArthur\'s use of tanks and tear gas against WWI veterans camped in Washington was a public relations disaster for Hoover.' },
            ...
            // Unit 8 extras
            { topic: '8.1', type: 'multiple_choice', stem: 'The Truman Doctrine (1947) committed the United States to:', choices: ['Defending only Western Europe from Soviet military aggression through NATO', 'Supporting free peoples resisting subjugation by armed minorities or outside pressures anywhere', 'Providing unlimited economic aid to all nations requesting assistance worldwide', 'Forming military alliances only with nations that held free and fair elections'], correct: 1, explanation: 'Announced to justify aid to Greece and Turkey, the Truman Doctrine set a broad precedent for American intervention wherever communism threatened.' },
            ...
            { topic: '8.2', type: 'multiple_choice', stem: 'HUAC (House Un-American Activities Committee) investigated:', choices: ['Only German spies and Nazi sympathizers operating inside the United States during WWII', 'Suspected communist infiltration in government, Hollywood, and American institutions', 'Soviet nuclear espionage specifically, focusing only on the theft of atomic bomb secrets', 'Labor union finances and strike funds to uncover illegal use of member dues'], correct: 1, explanation: 'HUAC\'s Hollywood investigations produced the "Hollywood Ten" — writers and directors who went to prison for refusing to cooperate.' },
            ...
            { topic: '8.4', type: 'multiple_choice', stem: 'Nixon\'s strategy of "Vietnamization" meant:', choices: ['Dramatically increasing American troop levels to overwhelm North Vietnamese forces', 'Gradually withdrawing U.S. troops and transferring fighting to South Vietnamese forces', 'Using nuclear threats to coerce North Vietnam into accepting a peace settlement', 'Expanding the ground war into China to cut North Vietnamese supply lines'], correct: 1, explanation: 'Vietnamization was Nixon\'s plan to end American involvement while maintaining South Vietnam — a strategy that ultimately failed.' },
            { topic: '8.4', type: 'multiple_choice', stem: 'The Pentagon Papers (1971) revealed:', choices: ['Extensive evidence of Soviet espionage operations deep inside the Defense Department', 'The government had systematically deceived the public and Congress about the Vietnam War\'s progress', 'That the Gulf of Tonkin incident that started the war had never actually happened', 'Nixon\'s secret plans to launch a ground invasion of North Vietnam in 1972'], correct: 1, explanation: 'Daniel Ellsberg leaked the classified history of U.S. Vietnam decision-making; it confirmed that presidents had lied to the public for years.' },
            { topic: '8.4', type: 'multiple_choice', stem: 'The War Powers Act (1973) was passed to:', choices: ['Increase and clarify presidential war powers so future conflicts could be fought more effectively', 'Require the president to notify Congress within 48 hours of deploying troops and limit deployments to 60 days without approval', 'Formally and legally end all U.S. military involvement in the Vietnam War', 'Give Congress the sole constitutional power to direct and command military operations'], correct: 1, explanation: 'Congress passed the War Powers Act over Nixon\'s veto to prevent future undeclared wars like Vietnam — though presidents have routinely disputed its constitutionality.' },

            { topic: '8.5', type: 'multiple_choice', stem: 'The Environmental movement was spurred largely by:', choices: ['A devastating major oil spill off the coast of Alaska that killed wildlife', 'Rachel Carson\'s Silent Spring (1962) exposing the dangers of pesticides like DDT', 'The Three Mile Island nuclear accident that released radiation into Pennsylvania', 'Severe air pollution choking Los Angeles residents throughout the 1970s decade'], correct: 1, explanation: 'Carson\'s book showing how DDT moved through the food chain launched modern environmentalism; the EPA was created in 1970.' },
            ...
            { topic: '8.6', type: 'multiple_choice', stem: 'Nixon\'s "Southern Strategy" involved:', choices: ['Directing large-scale federal economic investment and development spending into Southern states', 'Appealing to white Southern voters resentful of civil rights gains to build a Republican majority', 'Relocating major federal agencies and military bases from Northern to Southern states', 'Openly supporting racial segregation in campaign speeches to win Southern Democratic voters'], correct: 1, explanation: 'Nixon\'s coded racial appeals — "law and order," "silent majority" — attracted former Democratic white Southerners without explicitly endorsing segregation.' },
            ...
            // Unit 9 extras
            { topic: '9.1', type: 'multiple_choice', stem: 'The Iran-Contra affair revealed that the Reagan administration had:', choices: ['Openly and transparently negotiated with Iranian-backed terrorists to secure the release of hostages', 'Secretly sold weapons to Iran and used the profits to fund Nicaraguan rebels, violating Congressional restrictions', 'Launched an unauthorized military invasion of Iran without obtaining Congressional approval', 'Ordered the assassination of an Iranian government leader to destabilize the regime'], correct: 1, explanation: 'The scandal showed that Reagan officials had defied a congressional ban on Contra funding — raising questions about who was really in charge.' },
            { topic: '9.1', type: 'multiple_choice', stem: 'Reagan\'s approach to unions was shown by his response to the PATCO strike (1981), in which he:', choices: ['Quickly negotiated a compromise settlement that gave workers a partial wage increase', 'Fired 11,000 striking air traffic controllers and banned them from federal employment', 'Publicly supported the workers\' demands for higher wages and better working conditions', 'Referred the labor dispute to a neutral binding arbitration panel for resolution'], correct: 1, explanation: 'By firing the strikers (who were illegally striking as federal employees), Reagan sent a message to all unions about the limits of labor power.' },
            ...
            { topic: '9.2', type: 'multiple_choice', stem: 'The collapse of the Soviet Union (1991) resulted in:', choices: ['A single unified democratic Russian state inheriting all Soviet territory and institutions', '15 independent nations from former Soviet republics, including Russia, Ukraine, and the Baltic states', 'A swift military takeover of the Russian government by hard-line army generals', 'Immediate NATO membership granted to all former Soviet-controlled states and republics'], correct: 1, explanation: 'The USSR dissolved into 15 successor states; the largest and most powerful was the Russian Federation under Boris Yeltsin.' },
            ...
            { topic: '9.3', type: 'multiple_choice', stem: 'The Republican Revolution of 1994 brought a conservative House majority led by:', choices: ['Pat Buchanan and the populist Reform Party running on anti-immigration platforms', 'Newt Gingrich\'s "Contract with America" — promising welfare reform, term limits, and balanced budgets', 'Bob Dole\'s Senate Republicans who focused primarily on foreign policy and defense', 'Tea Party candidates who organized specifically to oppose Clinton\'s healthcare proposals'], correct: 1, explanation: 'Gingrich\'s Contract with America gave House Republicans a unified platform; the 1994 midterms gave them their first House majority in 40 years.' },
            { topic: '9.3', type: 'multiple_choice', stem: 'Welfare reform (1996) changed the system by:', choices: ['Significantly increasing benefits and expanding programs to address growing rates of poverty', 'Replacing AFDC with time-limited TANF requiring work — "ending welfare as we know it"', 'Completely federalizing all welfare programs under direct national government control', 'Dramatically expanding eligibility so many more low-income Americans could receive benefits'], correct: 1, explanation: 'The bipartisan welfare reform bill imposed work requirements and time limits on benefits — a major shift in social policy philosophy.' },
            ...
            { topic: '9.4', type: 'multiple_choice', stem: 'Income inequality grew significantly from the 1980s primarily because:', choices: ['Large-scale immigration dramatically reduced wages for native-born American workers', 'Tax cuts, deregulation, globalization, and technology disproportionately benefited the wealthy', 'Labor unions demanded excessively high wages that priced workers out of jobs', 'Government spending on social programs declined so dramatically that poverty increased'], correct: 1, explanation: 'The combination of Reagan-era tax cuts, financial deregulation, manufacturing offshoring, and the technology premium drove the widest inequality since the Gilded Age.' },
            { topic: '9.4', type: 'multiple_choice', stem: 'The TARP bank bailout (2008) was controversial because:', choices: ['It was immediately challenged and eventually ruled unconstitutional by the Supreme Court', 'It used taxpayer money to rescue financial institutions whose risky behavior had caused the crisis', 'It completely failed in its purpose and did not prevent a single major bank failure', 'It was rushed through without any Congressional debate, review, or approval vote'], correct: 1, explanation: 'Americans were outraged that Wall Street banks were rescued while millions of homeowners faced foreclosure — the "too big to fail" problem.' },
            ...
            { topic: '9.5', type: 'multiple_choice', stem: 'The Department of Homeland Security was created after 9/11 to:', choices: ['Completely replace both the CIA and FBI with a single unified intelligence agency', 'Consolidate domestic security agencies — FEMA, Secret Service, Coast Guard, Border Patrol — under one department', 'Conduct all foreign intelligence operations and overseas covert activities for the U.S.', 'Oversee and coordinate all military operations conducted on American domestic soil'], correct: 1, explanation: 'The 9/11 Commission found that poor coordination between agencies missed warning signs; DHS consolidated 22 agencies into one.' },
            ...
            { topic: '9.6', type: 'multiple_choice', stem: 'The Tea Party movement (2009–10) arose in opposition to:', choices: ['The ongoing Iraq War and the broader failures of Bush\'s foreign policy', 'Government spending, the bank bailouts, and the Affordable Care Act', 'Immigration and multiculturalism, which members saw as threats to American identity', 'Free trade agreements they argued were sending American jobs overseas'], correct: 1, explanation: 'The Tea Party channeled grassroots conservative anger at bailouts, stimulus spending, and the ACA into a political movement that shaped the 2010 midterms.' },
